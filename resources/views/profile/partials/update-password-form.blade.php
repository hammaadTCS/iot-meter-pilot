<section>
    <header class="mb-6">
        <h2 class="font-mono text-sm font-bold text-white uppercase tracking-widest">Update Password</h2>
        <p class="mt-1 text-sm text-iot-muted">Use a long, random password to keep your account secure.</p>
    </header>
        ...
        <div class="flex items-center gap-4 pt-2">
            ...
            @if (session('status') === 'password-updated')
                <p x-data="{ show: true }"
                   ...
                   class="text-sm text-iot-green">Updated.</p>
            @endif
        </div>
    </form>
</section>
